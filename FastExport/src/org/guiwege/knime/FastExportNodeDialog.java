...
public class FastExportNodeDialog extends DefaultNodeSettingsPane {
    ...
    protected FastExportNodeDialog() {
        ...
        SettingsModelBoolean booleanSettings = FastExportNodeModel.createAllColumnsAreStringsSettingsModel();
		
        // Set if columns will be all Strings or not
        addDialogComponent(new DialogComponentBoolean(booleanSettings, "All columns are String: "));
